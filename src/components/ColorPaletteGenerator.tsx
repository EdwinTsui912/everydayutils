...
<text x="${i * cw + cw / 2}" y="${h / 2 + 6}" text-anchor="middle" font-family="monospace" font-size="14" font-weight="bold" fill="${tc}">${s.hex.toUpperCase()}</text>`;
  ...
  return (
    <>
      <Helmet>
        <title>Color Palette Generator — Free, WCAG-Accessible, Private</title>
        <meta
          name="description"
          content="Generate harmonious, accessible color palettes instantly. Monochromatic, analogous, complementary, and triadic harmonies with live WCAG 2.2 contrast checking — 100% client-side, no sign-up."
        />
        <link rel="canonical" href="https://www.everydayutils.com/color-palette-generator" />
      </Helmet>
