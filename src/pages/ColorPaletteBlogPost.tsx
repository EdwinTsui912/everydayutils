...
const differentiators = [
  {
    label: 'Five harmony algorithms',
    detail:
      'Choose Random, Monochromatic, Analogous, Complementary, or Triadic — each computed from real color-wheel math, not just random hex values.',
  },
  {
    label: 'Lock any swatch',
    detail:
      'Like one color in a palette but not the rest? Lock it, and it stays put every time you regenerate the other four.',
  },
  {
    label: 'Built-in WCAG 2.2 contrast checks',
    detail:
      'Every swatch shows live AA/AAA contrast ratios against white and black, so you know instantly if text will actually be readable.',
  },
  {
    label: 'Advanced saturation & lightness control',
    detail:
      'Fine-tune how muted or vivid, and how dark or light, the whole palette skews — without starting over.',
  },
  {
    label: 'Multiple export formats',
    detail:
      'Copy as CSS custom properties, a ready-to-paste Tailwind config block, or a plain HEX list, plus a one-click SVG download of the strip itself.',
  },
  {
    label: '100% client-side & private',
    detail: 'All the color math runs locally in your browser. Nothing is sent to any server.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Absolutely. Every palette the tool generates is yours to use freely, whether that is a client project, a SaaS product, or something you plan to sell.',
  },
];
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      <header className="mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 leading-tight mb-4">
          I Kept Rebuilding the Same Tailwind Color Config — So I Built a Tool With Real Color
          Theory Behind It
        </h1>
        <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          Picking colors that actually work together, checking they are readable, then hand-typing
          them into a Tailwind config — this free tool handles all three steps at once.
        </p>
      </header>
      ...
      <div className="space-y-10">
        <section className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            Every time I started a new side project, I hit the same wall. I would try random hex
            codes next to each other, unsure whether they were actually harmonious or just
            accidentally not clashing, then separately worry about whether the text on top would
            even be readable. Once I landed on something, I still had to manually type every shade
            into a tailwind.config.js file by hand.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            So I built a tool that treats color choice as actual color theory rather than
            guesswork — pick a harmony rule, get a mathematically consistent palette, see instantly
            whether it passes accessibility standards, and export it in whatever format the project
            needs.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            The core of the tool is a harmony selector, and each option follows a distinct rule on
            the 360-degree color wheel rather than picking colors arbitrarily:
          </p>
        ...
        <section className="space-y-4">
          ...
          <ol className="space-y-4">
            {[
              <>
                Open the{' '}
                <Link to="/palette-generator" className="text-brand-500 hover:underline">
                  Color Palette Generator
                </Link>{' '}
                and pick a harmony type that fits the project's mood.
              </>,
              <>
                Click{' '}
                <strong className="text-gray-800 dark:text-gray-200 font-semibold">
                ...
                until something clicks, locking any swatch I already like so it survives future
                regenerations.
              </>,
              <>
                Open the{' '}
                ...
                to nudge saturation or lightness, and check the WCAG contrast table to confirm text
                will actually be readable.
              </>,
              <>
                Switch to the{' '}
                <strong className="text-gray-800 dark:text-gray-200 font-semibold">
                ...
                and copy the ready-made config block straight into the project.
              </>,
            ].map((step, i) => (
        ...
        <div className="flex items-start gap-3 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/50">
          ...
          <p className="text-sm text-emerald-800 dark:text-emerald-300 leading-relaxed">
            <strong className="font-semibold">Privacy Note:</strong> All palette generation and
            contrast math happens entirely in your browser. No color data, no settings, and no
            usage is ever sent to any server.
          </p>
        </div>
        ...
        {/* New card-style related section */}
        <section className="space-y-4">
