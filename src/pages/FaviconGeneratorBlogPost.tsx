    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      <header className="mb-8">
        ...
        <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          A good set of favicons makes your website look professional on browser tabs, bookmarks,
          and mobile home screens. This tool turns any logo into a complete favicon package in
          seconds.
        </p>
      </header>
      ...
      <div className="space-y-10">
        <section>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            A missing or blurry favicon makes your site look unprofessional. Browsers show a
            default blank icon, which hurts first impressions on tabs, bookmarks, and mobile home
            screens — small detail, but it's one of the first things people notice.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            A Quick Note on the .ico File
          </h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            Worth being upfront about: the favicon.ico this tool produces is generated from the
            32x32 PNG rather than a true multi-resolution ICO container. That's not a limitation
            you'll usually notice, since modern browsers rely mainly on the sized PNG link tags
            anyway — but if you're specifically relying on the .ico file to carry multiple embedded
            resolutions, this one won't do that.
          </p>
        </section>
        ...
        <div className="flex items-start gap-3 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/50">
          ...
          <p className="text-sm text-emerald-800 dark:text-emerald-300 leading-relaxed">
            <strong className="font-semibold">Privacy First:</strong> All image processing happens
            locally in your browser using canvas rendering. Your logo and generated icons never
            leave your device.
          </p>
        </div>
